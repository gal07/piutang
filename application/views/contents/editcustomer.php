...
<head>
    ...
    <title>Edit Customer <?= $customer[0]['nama']?> | Aplikasi Pencatatan Hutang</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <?php echo form_open('pages/UpdateCustomer?id='.$customer[0]['no_telp'].'') ;?>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" value="<?=$customer[0]['nama']?>" class="form-control" id="exampleInputuname2" name="nama" placeholder="Nama..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input required type="number" value="<?=$customer[0]['no_telp']?>" name="no_telp" class="form-control" id="exampleInputEmail2" placeholder="No Telepon..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" value="<?=$customer[0]['utang']?>" name="utang" class="form-control" id="exampleInputpwd2" placeholder="Pinjaman...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input required type="text" value="<?=$customer[0]['piutang']?>" name="piutang" class="form-control" id="exampleInputpwd3" placeholder="Piutang...">
                                            <div class="input-group-addon"><i class="ti-money"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputuname2">Diskon</label>
                                        <div class="input-group">
                                            <input required type="number" max="20" value="<?=$customer[0]['diskon']?>" class="form-control" id="exampleInputuname2" name="diskon" placeholder="Diskon..">
                                            <div class="input-group-addon"><i class="ti-user"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputuname2">Alamat</label>
                                        <div class="input-group">
                                            <textarea name="alamat" cols="30" rows="10" class="form-control"><?=$customer[0]['alamat']?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="text-left">
